...
if state.ui.helpOpen then
      ...
      ImGui.TextWrapped("Force Full Load is directly above Load Selected Preset. Force Full Load cautions also appear in the Load status card.")
      ...
      ImGui.TextWrapped("The selected preset card keeps its name, folder, saved-option count, source, changed date, tags, and notes together. Open Preset Options for actions only.")
      ...
      helpButton("Preset Options / Hide Preset Options", "Shows or hides Check Compatibility and the favorite action. Preset information stays in the card above it.")
      ...
      helpButton("Force Full Load: On / Off", "Turns saved-position matching on or off. It can help older presets find renamed options, but you should check the result after loading.")
