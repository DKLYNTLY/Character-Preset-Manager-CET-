...
if state.ui.helpOpen then
      ...
      ImGui.TextWrapped("Open Preset Options for the manual compatibility check, saved preset details, and the favorite action.")
      ...
      helpButton("Preset Options / Hide Preset Options", "Shows or hides Check Compatibility, the selected preset's source, changed date, tags, notes, and favorite action.")
